  ...
  var transformationList = function(result, tagName, format) {
    ...
    for (i = 0; i < format.length; i++) {
      ...
      if (format[i] === '*summary*') {
        ...
        if(!!description)
        output = output.concat('<br><br><span class="description" style="white-space: pre-wrap;">' + description + '</span>');
  ...
  return {
    init: function(settingsOverride) {
      var settings = {
        ...
        upcomingTopN: -1,
        itemsTagName: 'li',
        timeMin: '2019-09-06T18:38:10 -05:00',
        timeMax: '2020-09-06T20:38:10 -05:00'
